  ...
  render() {
    return h(
      ...
      this.showDownloadLink
        ? h(
            "div",
            { class: "download-pdf screen-only" },
            h(
              "a",
              {
                href: "https://github.com/matfantinel/resume/raw/master/Matheus%20Fantinel's%20Resume.pdf",
              },
              "Download as PDF"
            )
          )
      ...
      h(
        ...
        h(
          ...
          h(
            ...
            h("span", null, this.calcYearsSince("1995-08-24"), " years old")
          ),
          h(
            "li",
            { class: "experience" },
          ...
          h(
            ...
            h(
              "a",
              { href: "https://fantinel.dev", target: "_blank" },
              "fantinel.dev"
            )
          ),
          h(
            "li",
            { class: "github screen-only" },
            h("svg-icon", { name: "github" }),
            h(
              "a",
              { href: "https://github.com/matfantinel", target: "_blank" },
              "GitHub Profile"
            )
          ),
          h(
      ...
      h(
        ...
        h(
          "p",
          null,
          "I have a passion for building fast, responsive and pretty UIs, bringing great designs to reality and improving them as they get built. I love learning new things and applying them in practical solutions, either improving existing services or building completely new ones."
        )
      ),
      h(
        "section",
        ...
        h(
          ...
          h(
            ...
            h(
              "div",
              { class: "title" },
              h("div", null, h("span", { class: "company-name" }, "Logitix")),
              h(
                "small",
                null,
                "Software Engineer | ",
